...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "460029f3-2815-4832-abe9-fbd6ec14e5fc",
...
const _lazy_PWuTkL = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_PWuTkL, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_PWuTkL, lazy: true, middleware: false, method: undefined }
];
...
export { getRouteRules as a, useNitroApp as b, createError$1 as c, defineRenderHandler as d, getResponseStatusText as e, getResponseStatus as f, getQuery as g, handler as h, joinRelativeURL as j, useRuntimeConfig as u };
