...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getRequestHost, getRequestProtocol, setHeader, getResponseStatus, getHeader, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve as resolve$1, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, hasProtocol, withHttps, decodePath, withLeadingSlash, withoutTrailingSlash, withoutProtocol, joinRelativeURL, withBase } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/nuxt/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1, createConsola } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/nitropack/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/errx/dist/index.js';
import { isVNode } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/nuxt/node_modules/vue/index.mjs';
import devalue from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { toValue } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2 } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/unhead/dist/server.mjs';
import { toValue as toValue$1, isRef } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/@unhead/vue/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/marquisabah/Documents/msc-admin/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/marquisabah/Documents/msc-admin/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/marquisabah/Documents/msc-admin","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/marquisabah/Documents/msc-admin/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/marquisabah/Documents/msc-admin/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/marquisabah/Documents/msc-admin/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/marquisabah/Documents/msc-admin/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "supabaseUrl": "https://itjhtuzksirucwonaogi.supabase.co",
    "supabaseAnonKey": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml0amh0dXprc2lydWN3b25hb2dpIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU4NDUyMTMsImV4cCI6MjA3MTQyMTIxM30.uji2HiGgrk8fBmLyLl-ng5RBJsm6nJDjwP8xKYazeKk"
  },
  "nuxt-simple-sitemap": {
    "isI18nMapped": false,
...
const _e8Vajkbu7nqdo29rAZ8Gab7tTSztZjkYXPN8zS5h8c = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/marquisabah/Documents/msc-admin";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"format-detection","content":"telephone=no"},{"name":"description","content":"MSC - Revolutionary pharmaceutical distribution platform connecting suppliers, distributors, and pharmacies across Africa. Quality medicines, transparent pricing, and reliable delivery."},{"name":"keywords","content":"Medical Supply Chain, Pharmaceutical Distribution, Africa Healthcare, Pharmacy Platform, Medicine Supply, Healthcare Technology, Pharmaceutical Sourcing, Medical Logistics"},{"name":"author","content":"MSC - Medical Supply Chain"},{"property":"og:title","content":"MSC - Medical Supply Chain | Pharmaceutical Distribution Platform"},{"property":"og:description","content":"Revolutionary pharmaceutical distribution platform connecting suppliers, distributors, and pharmacies across Africa. Quality medicines, transparent pricing, and reliable delivery."},{"property":"og:type","content":"website"},{"property":"og:url","content":"https://msc.africa.com"},{"property":"og:image","content":"https://msc.africa.com/msc-logo.png"},{"property":"og:site_name","content":"MSC - Medical Supply Chain"},{"property":"og:locale","content":"en_US"},{"name":"twitter:card","content":"summary_large_image"},{"property":"twitter:url","content":"https://msc.africa.com"},{"name":"twitter:title","content":"MSC - Medical Supply Chain"},{"name":"twitter:description","content":"Revolutionary pharmaceutical distribution platform connecting suppliers, distributors, and pharmacies across Africa."},{"name":"twitter:image","content":"https://msc.africa.com/msc-logo.png"},{"name":"twitter:site","content":"@msc_africa"},{"name":"robots","content":"index, follow"},{"name":"googlebot","content":"index, follow"},{"name":"theme-color","content":"#3B82F6"},{"name":"msapplication-TileColor","content":"#3B82F6"},{"name":"apple-mobile-web-app-capable","content":"yes"},{"name":"apple-mobile-web-app-status-bar-style","content":"default"},{"name":"apple-mobile-web-app-title","content":"MSC"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"canonical","href":"https://msc.africa.com"},{"rel":"apple-touch-icon","sizes":"180x180","href":"/msc-logo.png"},{"rel":"icon","type":"image/png","sizes":"32x32","href":"/msc-logo.png"},{"rel":"icon","type":"image/png","sizes":"16x16","href":"/msc-logo.png"},{"rel":"manifest","href":"/site.webmanifest"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Lexend+Tera:wght@100..900&family=Rethink+Sans:ital,wght@0,400..800;1,400..800&display=swap"}],"style":[],"script":[],"noscript":[],"title":"MSC - Medical Supply Chain | Pharmaceutical Distribution Platform","htmlAttrs":{"lang":"en"}};
...
const _HzjWYl23T_iY4evpoGoKisLb_bbl8KX4pS1Retdwspg = (nitroApp) => {
...
const _s7kaV06lxC3QeDAyksaZk1cSdBNC9K7iOvnR4FCvw8 = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _e8Vajkbu7nqdo29rAZ8Gab7tTSztZjkYXPN8zS5h8c,
_HzjWYl23T_iY4evpoGoKisLb_bbl8KX4pS1Retdwspg,
_s7kaV06lxC3QeDAyksaZk1cSdBNC9K7iOvnR4FCvw8
];
...
const _Vn5fYf = eventHandler((event) => {
...
const _XXeVku = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _0e1K6T = eventHandler(async (e) => {
...
const _vXRiMQ = defineEventHandler(async (e) => {
...
const _94ljmX = defineEventHandler(async (e) => {
...
const __aSXSK = defineEventHandler(async (e) => {
...
const getClientManifest = () => import('file:///Users/marquisabah/Documents/msc-admin/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_Z6ybdZ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _Vn5fYf, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_Z6ybdZ, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _XXeVku, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _0e1K6T, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _vXRiMQ, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _94ljmX, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: __aSXSK, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_Z6ybdZ, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Z6ybdZ, lazy: true, middleware: false, method: undefined }
];
